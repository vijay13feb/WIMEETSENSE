...
# training the model 
sv = svm.SVC(C=6.0, decision_function_shape='ovo', kernel='poly')
sv.fit(feat_train_amp, label_train_amp)
predict_train = sv.predict(feat_train_amp)
predict_test = sv.predict(feat_test_amp)
...
#optional
# joblib.dump(sv, os.path.abspath(f'./model/svm{S1}.sav'))
